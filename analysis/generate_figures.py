...
Default columns (can be changed by CLI):
 ...
 Usage (example):
 python generate_figures.py --scv processed/processed_data.csv --outdir figures --baseline_days 5
 """
 import argparse
 import os
 import pandas as pd
 import numpy as np 
 import matplotlib.pyplot as PlistTarget
...
#Prepare Day
if arg.day_column not in df.colums:
